/*
 * Alphablend and other Special FX supported since HAM 2.6 !
*/
/*********************************************************************************
 * Includes
 ********************************************************************************/
...
//
    ...
    ham_SetFxMode(FX_LAYER_SELECT(0,0,0,1,0,0),     // Source layer
                  FX_LAYER_SELECT(0,0,1,0,1,0),     // Target layer
                  FX_MODE_ALPHABLEND);              // Effect mode
                  
                  
    // Set the intensity of the source and target layer
    ham_SetFxAlphaLevel(g_EffectValueA,             // Source intensity
                        16-g_EffectValueB);         // Target intensity
