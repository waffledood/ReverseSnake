...
int main(void)
{
   ...
   while(1)
   {
      ...
      // Plott pixel (a blue pixel in the middle of the screen)
      ham_PutPixel(120,  // x coordinate of the pixel you want to set
                   80,   // y coordinate of the pixel you want to set
