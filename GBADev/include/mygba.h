...
#define HAM_CURRENT_VERSION_MINOR 71
...
#define TOOL_PROFILER_INIT u32 ham_prof_subticks=0; \
                          u32 ham_prof_scanline_start,ham_prof_scanline_end; \
                          u32 ham_prof_frames_elapsed; \
                          u32 ham_prof_first_run=1; \
                          void ham_prof_timer3_int() \
                          { ham_prof_frames_elapsed++;  }

#define TOOL_PROFILER_START if(ham_prof_first_run)\
                            {\
                            ham_VBAText("HAM Profiler started.     Profiler measures time in ticks.\n"); \
                            ham_VBAText("                                     1 Frame = 4399 Ticks.\n"); \
                            ham_VBAText("---------------+---------------+--------------+-----------\n"); \
                            ham_VBAText("Frames elapsed | Ticks elapsed | Scanl. Start | Scanl. End\n"); \
